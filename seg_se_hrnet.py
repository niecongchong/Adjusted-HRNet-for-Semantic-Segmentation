...
def _squeeze_excite_block(init, filters):
...
def fuse_layer1(x):
    x0_0 = x[0]
    se0_0 = _squeeze_excite_block(x0_0, 32)
    x0_0 = multiply([x0_0, se0_0])
    ...
    se0_1 = _squeeze_excite_block(x0_1, 32)
    x0_1 = multiply([x0_1, se0_1])
    ...
    se1_0 = _squeeze_excite_block(x1_0, 64)
    x1_0 = multiply([x1_0, se1_0])

    x1_1 = x[1]
    se1_1 = _squeeze_excite_block(x1_1, 64)
    x1_1 = multiply([x1_1, se1_1])
...
def fuse_layer2(x):
    ...
    se0_2 = _squeeze_excite_block(x0_2, 32)
    x0_2 = multiply([x0_2, se0_2])
    ...
    se1_2 = _squeeze_excite_block(x1_2, 64)
    x1_2 = multiply([x1_2, se1_2])
    ...
    x2_0 = BatchNormalization(axis=3)(x2_0)
    se2_0 = _squeeze_excite_block(x2_0, 128)
    x2_0 = multiply([x2_0, se2_0])
    ...
    se2_1 = _squeeze_excite_block(x2_1, 128)
    x2_1 = multiply([x2_1, se2_1])

    x2_2 = x[2]
    se2_2 = _squeeze_excite_block(x2_2, 128)
    x2_2 = multiply([x2_2, se2_2])
...
def fuse_layer3(x):
    ...
    se0_3 = _squeeze_excite_block(x0_3, 32)
    x0_3 = multiply([x0_3, se0_3])
...
def seg_se_hrnet(height=256, width=256, channel=3, classes=6):
